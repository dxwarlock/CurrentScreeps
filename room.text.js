module.exports = {
    run: function (spawn) {
        ...
        spawn.room.visual.text("COST: " + spawn.room.memory.cost + " | HAVE: " + roomPower + ' | ext:'+ roomextcount.length +' | Min to save:'+ spawn.room.energyAvailable+'/'+spawn.room.memory.minEnergy, x, y + 1, textFormatTop);
        ...
        spawn.room.visual.text("GCL: " + (Game.gcl.progress/Game.gcl.progressTotal*100).toFixed(4)+'%' + ' LEVEL: '+ contollerLevel[0].level, x, y + 4.1, textFormatTop);
        //SPAWN TEXT
