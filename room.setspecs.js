module.exports = {
	setSpecs: function (spawn) {
		...
		if (PowerTotal <= 300) {
			...
			spawn.room.memory.dropped = 1;
			spawn.room.memory.minEnergy = 350;
			spawn.room.memory.Population = { 'harvester': sourecount, 'carry': sourecount * 2, 'upgrader': sourecount * 2, 'helper': sourecount * 2, 'builder': sourecount, 'guard': 0, 'claim': 0 };
			...
			spawn.room.memory.minEnergy = 450;
			spawn.room.memory.Population = { 'harvester': sourecount, 'carry': sourecount * 2, 'upgrader': sourecount * 2, 'helper': sourecount * 2, 'builder': sourecount, 'guard': 1, 'claim': 0 };
			...
			spawn.room.memory.dropped = 40;
			spawn.room.memory.minEnergy = 450;
			spawn.room.memory.Population = { 'harvester': sourecount, 'carry': sourecount * 2, 'upgrader': sourecount, 'helper': sourecount * 2, 'builder': sourecount, 'guard': 1, 'claim': 0 };
			...
			spawn.room.memory.dropped = 40;
			spawn.room.memory.minEnergy = 450;
			spawn.room.memory.Population = { 'harvester': sourecount, 'carry': sourecount * 2, 'upgrader': sourecount, 'helper': sourecount * 2, 'builder': sourecount, 'guard': 2, 'claim': 1 };
			spawn.room.memory.creepSpecs['harvester'] = [WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE];
			...
			spawn.room.memory.dropped = 40;
			spawn.room.memory.minEnergy = 450;
			spawn.room.memory.Population = { 'harvester': sourecount, 'carry': sourecount * 2, 'upgrader': sourecount, 'helper': 2, 'builder': 2, 'guard': 4, 'claim': 1 };
			spawn.room.memory.creepSpecs['harvester'] = [WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE];
			spawn.room.memory.creepSpecs['carry'] = [CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, ATTACK];
			spawn.room.memory.creepSpecs['upgrader'] = [WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE];
			spawn.room.memory.creepSpecs['helper'] = [CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE];
