	...
	SpawnStuff: function () {
		...
		for (var name in Game.spawns) {
			...
			if (PowerTotal <= 300) {
				...
				Memory.rooms[roomName].Population = { 'harvester': sourecount, 'carry': sourecount * 2, 'upgrader': 1, 'helper': 2, 'builder': 2, 'guard': 2 };
				...
				spawn.room.memory.dropped = 250;
				Memory.rooms[roomName].Population = { 'harvester': sourecount, 'carry': sourecount * 3, 'upgrader': 1, 'helper': 2, 'builder': 2, 'guard': 2, 'claim': 1 };
				spawn.room.memory.creepSpecs['harvester'] = [WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE];
